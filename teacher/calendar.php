...
$page_title = "Academic Calendar | Enlight";
            ...
            <div class="content-area">
                <div class="d-flex justify-content-between align-items-center mb-5 animate-up">
                    <div>
                        ...
                        <p class="text-muted small fw-600">Faculty Academic Planner. Click any day to view your teaching schedule.</p>
                    </div>
                ...
                <div class="calendar-grid animate-up">
                    ...
                    for($day = 1; $day <= $numberDays; $day++) {
                        ...
                        if($isWeekend) {
                            ...
                            echo "<div class='calendar-event' style='background: #e0e7ff; color: #4338ca;'>Teaching Session</div>";
                        }
                        
                        // Example events
                        if($day == 5) echo "<div class='calendar-event' style='background: #fef3c7; color: #b45309;'>Faculty Meeting</div>";
                        
                        echo "<div class='timetable-hint'>My Schedule <i class='fas fa-arrow-right ms-1'></i></div>";
                        echo "</div>";
                        echo "</a>";
                    }
                    ?>
